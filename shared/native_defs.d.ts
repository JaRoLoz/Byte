...
export interface XMLTagAttribute {
    name: string,
    value: string
}
...
export interface XMLNode {
    tag: string,
    orderedattrs: Array<XMLTagAttribute>,
...
export type XMLChild = XMLText | XMLNode;

export interface XMLRoot {
    entities: Array<XMLEntity>,
    children: Array<XMLChild>
}

export interface CfxPromise<Args extends any[]> {
    resolve: (promise: CfxPromise<Args>, ...result: Args) => void;
    reject: (promise: CfxPromise<Args>, reason: any) => void;
}
...
declare global {
    ...
    var XML: {
        decode: (data: string) => XMLRoot;
    };

    var promise: {
        new: <Args extends any[]>() => CfxPromise<Args>;
    };
    ...
    var Citizen: {
        ...
        PointerValueFloat: () => void;
        PointerValueFloatInitialized: (n: any) => void;
        ReturnResultAnyway: () => void;
    };
